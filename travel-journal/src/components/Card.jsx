...
const Card = (props) => {
    return (
        <div className="card-container">
            <img className="card--image" src={props.item.imageUrl} alt="Card Image"/>
            <div className="card--details">
                <div className="card--location">
                    <svg className="card--map-logo" width="7" height="9" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="card--google-maps" href={props.item.googleMapsUrl}>View on Google Maps</a>
                </div>
